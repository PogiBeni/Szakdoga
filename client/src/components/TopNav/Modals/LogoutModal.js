                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body d-flex align-items-center flex-column">
                        <div className="d-flex mt-4">
                            <button type="button" className="btn btn-light border bg-white me-3 btn-lg " data-bs-dismiss="modal">Back</button>
                            <button type="button" className="btn btn-warning btn-lg" onClick={signOut}>Logout</button>
                        </div>
                    </div>
                </div>
            </div>
